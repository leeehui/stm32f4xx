...
#define ws2812_port_set ((uint32_t*)&GPIOB->BSRRL)	// Address of the data port register to set the pin
#define ws2812_port_clr	((uint32_t*)&GPIOB->BSRRH)	// Address of the data port register to clear the pin
